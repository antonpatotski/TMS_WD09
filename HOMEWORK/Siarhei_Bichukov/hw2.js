...
export function hW2(){
    ...
    function Task1() {
        const a = console.log(typeof("true"));
        const b =console.log(typeof(false));
        const c =   console.log(typeof(17));
        const d = console.log(typeof(undefined));
        const e =  console.log(typeof(null));
    }
     Task1();
